...
<?php 
    foreach($productsDetails as $key=>$product) {
            $totalPriceform[]=$product->productdetails->price * $qty_array[$key];
    }
?>
                ...
                <div class="checkout-info ">
                    ...
                    <div class="shipping-form my-5">
                        <form method="post" action="{{route('pay')}}">
                            {{csrf_field()}}
                            <input type="hidden" name="price" value="{{array_sum($totalPriceform) + 66}}">
                            <input type="hidden" name="name" value="productsnames">
